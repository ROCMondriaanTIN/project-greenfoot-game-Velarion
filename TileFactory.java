    ...
    public Tile createTile(int mapIcon) {
        ...
        switch (mapIcon) {
             ...
             case  87:
                  ...
                  break;
             case  88:
                  tile = new Tile("p1_stand.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                  tile.isSolid = true;  
                  break;
             case  89:
                  tile = new Tile("p2_stand.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                  tile.isSolid = true; 
                  break; 
             case  90:
                  tile = new Tile("p3_stand.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
                  tile.isSolid = true; 
                  break; 
             case  91:
